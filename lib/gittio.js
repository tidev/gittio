...
function _uninstallWidget(o) {
  if (config.context === 'global' ||
      !fs.existsSync(config.widgets_path)) {
    return false;
  }
...
function _installSingle(o) {
  component.lookup(o.id, function(err, info) {
    ...
    if (o.version && o.version !== '*') {
      ...
      if (!target) {
        logger.error(o.id + (o.version ? '@' + o.version : "") + " does not exist" + (o.platform ? " for " + o.platform : ""));
        return;
      }
