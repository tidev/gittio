...
var path_config = path.join(path_home, '.gittio.json');

function read() {
  return fs.existsSync(path_config) ? require(path_config) : {}
}
...
exports.init = function(global_flag, callback) {
  ...
  exports.registryUrl = cfg['registry.url'] || 'http://registry.gitt.io/';
