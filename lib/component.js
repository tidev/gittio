...
exports.lookup = function(id, callback, silent) {

  if (!silent) {
    logger.info(utils.prefix(id) + ' searching...');
  }
  ...
  request(url, function(error, response, body) {
    ...
    if (!error && response.statusCode == 200) {
      ...
      callback(id + ' error contacting registry', null);
    }
  });
};
